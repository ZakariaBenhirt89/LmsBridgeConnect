...
/*
  ...
  ```
*/
const  logoUrl = 'https://res.cloudinary.com/daog54j96/image/upload/v1623322797/Sans_titre-1_copie_q58yiq.png'
export default function Signup() {
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <img
                    className="mx-auto h-12 w-auto animate-bounce delay-500"
                    src={logoUrl}
                    alt="Workflow"
                />
